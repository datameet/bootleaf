...
var wards = L.geoJson(null, {
  ...
  onEachFeature: function (feature, layer) {
    wardsSearch.push({
      name: layer.feature.properties.WARD_NAME,
      source: "Wards",
      id: L.stamp(layer),
...
$.getJSON("data/wards.geojson", function (data) {
  wards.addData(data);
});
...
$.getJSON("data/road1.geojson", function (data) {
  roads1.addData(data);
});
...
//map.addLayer(wards).addLayer(roads1);
